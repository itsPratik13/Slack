...
export const SignInCard = ({setState}:SignInCardProps) => {
  ...
  return (
    <Card className="h-full w-full p-8">
      ...
      <p className=" my-3 text-sx text-muted-foreground">Don't have an account? <span 
      onClick={()=>setState("signUp")} className="text-sky-700 hover:underline cursor-pointer">SignUp!</span></p>
    </Card>
  );
};
